...
Default model: sam2.1-hiera-large
"""
...
# --- Import GUI module ---
try:
    from gui.gui_gpu import BioticSegmentation
except ImportError as e:
    print(f"[ERREUR] Impossible de trouver gui_gpu.py dans {project_path}/gui")
